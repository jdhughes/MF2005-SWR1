...
! write wells with reduced pumping
      IF (Qp.LT.0.9999999D0.AND.Iunitnwt.NE.0)THEN
        IF ( iw1.EQ.1 ) THEN
          WRITE(IUNITRAMP,*)
...
! dC is the derivative of well conductance with respect to well head
      ...
      USE FMPMODULE, ONLY:PSIRAMPF               !added variable for connection between Smoothing and FMP single-aquifer wells by rth
      IMPLICIT NONE
