...
C9------RETURN
      ...
      RETURN
      END
      SUBROUTINE GWF2LPF7AD(KPER,IUNITSUB,IGRID)                       !ADDED IUNITSUB WSCHMID
C     ******************************************************************
...
C     ------------------------------------------------------------------
     ...
     1                      ,LAYCBD                                     !added for detecting confining beds - WSCHMID
      USE GWFLPFMODULE,ONLY:LAYWET,WETDRY !,SC1                         !SUB-Linkage rth    !wschmid: SC1 no longer needed --> adjusted in FM
      USE GWFSUBMODULE, ONLY: DVZ,LPFLNK   !DCOME,DCOMV                 SUB-Linkage rth     !wschmid: DCOME,DCOMV no longer needed
cws      USE GLOBAL,      ONLY: CR,CC                                   !SUB-Linkage rth  !wschmid: CR, CC no longer needed --> adjusted in FM
C     ------------------------------------------------------------------
      INTEGER IUNITSUB                                                 !ADDED IUNITSUB WSCHMID
ccrth      REAL THK,THKOLD                                                   !SUB-Linkage rth
C
...
C2C-----SET HOLD=BOT
  ...
  100 CONTINUE
cc
      IF(IUNITSUB.GT.0)THEN                                             !ADDED IUNITSUB WSCHMID
      IF(LPFLNK)THEN                                                    !SUB-Linkage rth  
