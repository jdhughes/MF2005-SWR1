...
c        INTEFGER,SAVE,POINTER ::ISUBLNK,ILPFLNK                         !SUB-Linkage rth
        INTEGER,SAVE,POINTER ::ISUBLNK,ILPFLNK                         !SUB-Linkage rth 
        REAL,   SAVE,POINTER ::AC1,AC2
        LOGICAL,SAVE,POINTER ::NDF,NNDF,SUBLNK,LPFLNK                  !SUB-Linkage rth
        ...
        REAL,   SAVE, DIMENSION(:,:,:), POINTER ::DVZ                  !SUB-Linkage rth
        REAL,   SAVE, DIMENSION(:,:,:), POINTER ::DVZC                 !WSCHMID
      TYPE GWFSUBTYPE
        ...
        LOGICAL, POINTER  ::NDF,NNDF,SUBLNK,LPFLNK                     !SUB-Linkage rth
        ...
        REAL,    DIMENSION(:,:,:), POINTER ::DVZ                  !SUB-Linkage rth
        REAL,    DIMENSION(:,:,:), POINTER ::DVZC                 !WSCHMID
      END TYPE
...
C     ------------------------------------------------------------------
     ...
     5                      ISUBLNK,ILPFLNK,SUBLNK,LPFLNK,DVZ,                !SUB-Linkage rth
     6                      DVZC                                        !WSCHMID
C
      DIMENSION IFL(21)
...
C     ------------------------------------------------------------------
      ALLOCATE (IIBSCB,ITMIN,NNDB,NDB,NMZ,NN,ND2,IDSAVE,ISUBLNK,ILPFLNK)                !SUB-Linkage rth
      ALLOCATE (AC1,AC2)
      ALLOCATE (NDF,NNDF,SUBLNK,LPFLNK)                !SUB-Linkage rth
...
C4------CRITICAL HEAD ARRAYS.
      ...
      CALL URWORD(LINE,LLOC,ISTART,ISTOP,2,ISUBLNK,R,IOUT,IN)                !SUB-Linkage rth
      CALL URWORD(LINE,LLOC,ISTART,ISTOP,2,ILPFLNK,R,IOUT,IN)                !SUB-Linkage rth
      ...
      ENDIF
cc
      IF(ISUBLNK.gt.0)then                                                !SUB-Linkage rth
...
C     ------------------------------------------------------------------
     ...
     3                        SUBLNK,LPFLNK,DVZ			               !SUB-Linkage rth 
      USE GWFNWTMODULE, ONLY: ICELL
      USE GWFUPWMODULE, ONLY: Sn, LAYTYPUPW
      CHARACTER*16 TEXT(2)
C
...
C     ------------------------------------------------------------------
     ...
     &                        SUBLNK,LPFLNK,DVZ,			               !SUB-Linkage rth 
     &                        DVZC                          !WSCHMID
