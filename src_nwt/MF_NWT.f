...
C-------ASSIGN VERSION NUMBER AND DATE
      ...
      PARAMETER (MFVNAM='-NWT-SWR1-SWI2')
C
...
!      IF(IUNIT(59).GT.0) CALL PCGN2AR(IUNIT(59),IFREFM,MXITER,IGRID)
     ...
     3                        IUNIT(62),IUNIT(44),IUNIT(63),IGRID)  !SWR  - JDH
      IF(IUNIT(65).GT.0) CALL GWF2SWI1AR(IUNIT(65),
     2                        IUNIT(1),IUNIT(23),IUNIT(37),IGRID)   !SWI  - JDH
      IF(IUNIT(66).GT.0) CALL GWF2XXX7AR(IUNIT(66),IGRID)
...
!     1                          IUNIT(44),IUNIT(52),IGRID)     
        ...
        IF(IUNIT(66).GT.0) CALL GWF2XXX7RP(IUNIT(66),IGRID)
C
...
C7C1----CALCULATE TIME STEP LENGTH. SET HOLD=HNEW.
     ...
     1                                           IGRID)
          IF(IUNIT(65).GT.0) CALL GWF2SWI1AD(KKSTP,KKPER,IGRID)  !SWI
...
!     1                              IUNIT(44),IUNIT(52),IUNIT(55),IGRID)
     ...
     1                                         IUNIT(9),IGRID)
            ...
            IF(IUNIT(65).GT.0) CALL GWF2SWI1FM(KKSTP,KKPER,KKITER,IGRID)  !SWI - JDH
            IF(IUNIT(66).GT.0) CALL GWF2XXX7FM(IGRID)
C
...
C-------ENSURE CONVERGENCE OF SWR - BASEFLOW CHANGES LESS THAN TOLF - JDH
            ...
            END IF
C
C-------ENSURE CONVERGENCE OF SWI ZETA FOR STEADY STATE STRESS PERIODS   !SWI - JDH
            IF(IUNIT(65).GT.0) THEN
              CALL GWF2SWICV(KKITER,IGRID,ICNVG)
            END IF
C
...
! Moved call to UZF1BD to follow SFR7BD for printing net recharge in UZF.
     ...
     1                      IGRID)
          ...
          IF(IUNIT(65).GT.0) CALL GWF2SWI1BD(KKSTP,KKPER,IGRID)  !SWI - JDH
          IF(IUNIT(66).GT.0) CALL GWF2XXX7BD(KKSTP,KKPER,IGRID) 
CLMT
...
!          CALL SAMG7DA(IGRID)
     ...
     1                                              IGRID)
      ...
      IF(IUNIT(65).GT.0) CALL GWF2SWI1DA(IGRID)  !SW1 - JDH
      IF(IUNIT(66).GT.0) CALL GWF2XXX7DA(IGRID)
